...
export default function FeaturedProjects() {
  ...
  // We don't stop lenis globally because that intercepts and prevents all wheel events.
  // Instead, we use data-lenis-prevent on the modal container to allow native scrolling.
  useEffect(() => {
    if (selectedProject) {
